    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        ...
        <div x-data="{ isOpen: false }">
            ...
            <div class="mt-12">
                <button 
                    @click="isOpen = true"
                    href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" target="_blank" class="max-w-xs w-40 flex items-center content-center  bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
