...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        ...
        <div class="mt-12">
            <a href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" target="_blank" class="max-w-xs w-40 flex items-center content-center  bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
...
<div class="movie-images">
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div class="mt-8">
                <a href="#">
                    <img src="{{ 'https://image.tmdb.org/t/p/w500'. $image['file_path'] }}" alt="{{ $image['vote_count'] }}" class="hover:opacity-75 transition ease-in-out duration-150">
                </a>
            </div>
            @endif
            @endforeach
